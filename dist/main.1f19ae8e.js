...
var x = localStorage.getItem('x'); //获取localStorage，第一次执行的为空

var xObject = JSON.parse(x); //将localStorage从字符串转化为对象

var hashMap = xObject || [//渲染哈希，或逻辑，如果xObject有内容则渲染，无则渲染后者
{
  logo: 'A',
...
window.onbeforeunload = function () {
  var myStorage = JSON.stringify(hashMap); //将哈希数组从对象转化为字符串
